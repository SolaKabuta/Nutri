    ...
    <main className="max-w-screen scroll-smooth pt-10 md:pt-20  lg:mx-0 lg:px-24">
      <motion.div 
        ...
        >
          ...
          engaging and informative content that will inspire and empower you to make informed decisions about your health. Explore our blog to discover a wealth of resources that <br />
