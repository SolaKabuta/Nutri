export const pricingCardMonthly = [
  {
    plan: "Basic Plan",
...
export const pricingCardYearly = [
  {
    plan: "Basic",
    discount: "Essential features for personal use",
    yearly: "/yearly",
    price: "$90",
    discountApplied: "Save 20%",
    features: [
  ...
  {
    plan: "Pro",
    discount: "Advanced features for enthusiasts",
    yearly: "/yearly",
    price: "$190",
    discountApplied: "Save 20%",
    features: [
  ...
  {
    plan: "Enterprise",
    discount: "Comprehensive solutions for businesses",
    yearly: "/yearly",
    price: "$490",
    discountApplied: "Save 20%",
    features: [
